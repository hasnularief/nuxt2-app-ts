  ...
  methods: {
    async getMovies() {
      ...
      const data = axios.get(`
        https://api.themoviedb.org/3/movie/now_playing?api_key=4ccdd9df6aa11856ff397bbdac402a47&language=id-ID&page=1`)
    ...
    async searchMovies() {
      const data = axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=4ccdd9df6aa11856ff397bbdac402a47&language=id-ID&page=1&query=${this.searchInput}`
      )
      const result = await data
      result.data.results.forEach((movie: any) => {
